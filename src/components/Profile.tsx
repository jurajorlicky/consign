    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white p-8 rounded-xl shadow-md w-full max-w-2xl relative max-h-[90vh] overflow-y-auto">
            <h2 className="text-2xl font-bold mb-4">Upraviť profil</h2>

            {error && (
              <div className="bg-red-50 text-red-600 p-2 mb-4 rounded">{error}</div>
            )}
            {successMessage && (
